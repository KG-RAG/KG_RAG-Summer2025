...
//    public KgDomain getDomainByLabel(String label) {
//        List<KgDomain> domains = (List<KgDomain>) knowledgeGraphDao.getDomainByLabel(label);
//        return (KgDomain) domains;
//    }
    ...
    @Override
    public void updateDomain(Integer domainId, String newDomain) {
        KgDomain item = selectById(domainId);
        item.setName(newDomain);
